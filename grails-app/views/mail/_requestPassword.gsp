...
<title><g:message code="mail.title.request.password"
...
<body>
	...
	<div id="content">
		<div class="box">
			...
			<p>
				<g:message code="mail.request.password.text"
					default="You have requested a new password for your oWrks account." />
			</p>

			<div style="margin: 10px 0;">
				<p>
					<g:message code="mail.user.password" default="Password: " />
					${password}
				</p>
			</div>
			<p>
