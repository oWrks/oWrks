...
-->
	...
	<title><g:message code="mail.title.invitation" default="Neuer Kommentar" /></title>
...
<body>
	<div id="content">
		<div class="box">
			...
			<p><g:message code="mail.newOwoPostComment.text" args="[ commentPoster, owoTitle ]" default="Ein Performer hat auf deine Nachricht geantwortet" /></p>
