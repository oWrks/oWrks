...
-->
        ...
        <g:set var="entityName" value="${message(code: 'userMessage.label', default: 'Outbox')}" />
    ...
    <div class="box">
        <div class="col1">
        <div class="list">
            <h2 class="info-list-header"><g:message code="userMessage.outbox.label" args="[entityName]" default="${entityName}" /></h2>
            <table>
                <thead>
                    <tr>	
  			           	<g:sortableColumn property="receiver" title="${message(code: 'userMessage.receiver.label', default: 'An')}" />
                ...
                <g:each in="${userMessageInstanceList}" status="i" var="userMessageInstance">
                    <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    	<td><g:link mapping="profile" id="${userMessageInstance.receiver.id}">${userMessageInstance.receiver}</g:link></td>
                        <td>
       ...
       <div class="col2">
        	...
        	<h2 class="box-header">Mailbox</h2>
        		<ul style="list-style-type: none;">
        			...
        			<li><g:link controller="userMessage" action="create" class="dialog">Nachricht erstellen</g:link></li>
        		</ul>
        	</div>
        </div>
        <div class="clear"></div>
